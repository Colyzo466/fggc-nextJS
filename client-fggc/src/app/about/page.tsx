      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-3xl w-full bg-gray-900/95 rounded-xl shadow-2xl p-10 flex flex-col items-center border border-yellow-800">
          ...
          <p className="text-lg sm:text-xl text-yellow-100 mb-6 text-center font-medium">
            Global Growth Peer Connection (GGPC) is a trusted peer-to-peer financial platform dedicated to empowering individuals and communities through transparent contributions and sustainable returns. Our mission is to foster financial growth, trust, and prosperity by connecting people in a secure, innovative, and supportive environment.
          </p>
